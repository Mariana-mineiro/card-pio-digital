      ...
      <div className="w-full max-w-lg rounded-3xl bg-white p-5 sm:p-6 shadow-2xl max-h-[90vh] overflow-y-auto">
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                <button type="button" onClick={onOpenCategoryModal} className="text-xs font-bold text-emerald-600 hover:underline">+ Nova</button>
              </div>
              <Controller
                control={control}
                name="category_id"
                render={({ field }) => {
                  ...
                  return (
                    <Select value={field.value} onValueChange={field.onChange}>
                      <SelectTrigger className="w-full rounded-xl border border-slate-200 bg-white px-3 py-5 text-sm">
          ...
          <div>
            ...
            <input type="file" accept="image/*" {...register("image")} className="w-full text-xs text-slate-500 file:mr-4 file:rounded-xl file:border-0 file:bg-emerald-50 file:px-4 file:py-2 file:text-xs file:font-bold file:text-emerald-700 hover:file:bg-emerald-100" />
          </div>
